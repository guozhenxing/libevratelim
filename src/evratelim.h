...
typedef void (*evratelim_suspend_cb)(evratelim_bev * rl_bev, short what, void * arg);
typedef void (*evratelim_resume_cb)(evratelim_bev * rl_bev, short what, void * arg);
...
void                 evratelim_bev_setcb(evratelim_bev * rl_bev, evratelim_suspend_cb scb, evratelim_resume_cb rcb, void * arg);
